...
# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', '/home/yuyongjian/ChatGLM3/models/chatglm3-6b')
TOKENIZER_PATH = os.environ.get("TOKENIZER_PATH", MODEL_PATH)

# set Embedding Model path
EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', '/home/yuyongjian/ChatGLM3/models/bge-large-zh-v1.5')
